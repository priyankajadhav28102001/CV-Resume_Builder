# Generated by Django 5.0.2 on 2024-06-19 01:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('e_responsibilities', models.TextField(max_length=10000)),
                ('e_startdate', models.DateField(blank=True, null=True)),
                ('e_enddate', models.DateField(blank=True, null=True)),
                ('cv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.cv')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_description', models.TextField(help_text='Enter a brief description of the project', max_length=10000)),
